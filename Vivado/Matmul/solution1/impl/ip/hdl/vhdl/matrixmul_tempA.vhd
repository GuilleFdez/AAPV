...
architecture rtl of matrixmul_tempA_ram is 
...
architecture arch of matrixmul_tempA is
    component matrixmul_tempA_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    matrixmul_tempA_ram_U :  component matrixmul_tempA_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
